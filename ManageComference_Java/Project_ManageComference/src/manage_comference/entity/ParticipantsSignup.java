...
/**
 * ParticipantsSignup generated by hbm2java
 */
public class ParticipantsSignup  implements java.io.Serializable {
    ...
    public ParticipantsSignup() {
    }

    public ParticipantsSignup(AdUser adUser, Hoinghi hoinghi) {
       this.adUser = adUser;
